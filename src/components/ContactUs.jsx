...
const ContactUs = () => {
  ...
  return (
    <div className="relative min-h-screen py-6 sm:py-12" id="contact">
      <div className="container mx-auto w-full px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 bg-white shadow-md p-6 rounded-lg">
          ...
          <div className="lg:w-1/2 flex flex-col gap-6 p-6 bg-[aliceblue] rounded-md">
            ...
            <div>
              <a
                href="https://maps.app.goo.gl/NZVq4kbP2532AmxR7"
                target="_blank"
                rel="noreferrer"
                className="flex gap-4 items-center py-4 border-b border-blue-100"
                ...
                <span className="text-gray-600 text-sm lg:text-lg">
                  Address: BSNL colony Saharanpur
                  <br /> Uttar Pradesh 247001
                </span>
              </a>
              <Tooltip id="location-tooltip" place="bottom" effect="solid">
                View on Google Map
              </Tooltip>
            </div>

            <div className="flex gap-4 items-center h-full py-4 border-b border-blue-100">
